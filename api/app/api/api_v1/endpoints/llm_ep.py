...
def rag_handler(req: Request) -> Dict[str, Any]:
    ...
    Please remember do not show the conetxt in the answer and do not show any XML tags in the answer. If you don't know the answer or if the answer is not in the context say "Sorry, I don't know."
