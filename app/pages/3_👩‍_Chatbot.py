...
api_text2text_ep:str =  f"{api}/api/v1/t2t/text2text"
...
def get_parmeters_k() -> int:
    ...
    top_k_sidebar = st.sidebar.slider("Top_k",min_value=1,value=250,max_value=500,step=1,key="slidera",
...
def get_parmeters_p() -> float:
    # top_k_input = st.sidebar.number_input( "top_k", value=DEFAULT_K,placeholder=DEFAULT_K,key="numeric",on_change=update_slider)
    top_p_sidebar = st.sidebar.slider("Top_p", value=0.99,min_value=0.1,max_value=1.0,step=0.005,key="sliderb",
...
def get_parmeters_length() -> int:
    # top_k_input = st.sidebar.number_input( "top_k", value=DEFAULT_K,placeholder=DEFAULT_K,key="numeric",on_change=update_slider)
    max_length_sidebar= st.sidebar.slider("Max_length",value=300,min_value=1,max_value=2048,step=2,key="sliderc",
...
def get_parmeters_temperature() -> float:
    # top_k_input = st.sidebar.number_input( "top_k", value=DEFAULT_K,placeholder=DEFAULT_K,key="numeric",on_change=update_slider)
    temperature_sidebar= st.sidebar.slider("Temperature",value=0.99,min_value=0.0,max_value=1.0,step=0.005,key="sliderd",
