...
######################## 页面配置初始化 ###########################
RANK_COLOR = ["red", "green", "blue", "orange", "violet","#00f900","#F90095","#C900F9","#F98300","#F98C00","#8C00F9","#00F9E3","#4F00F9","#F900B7"]
...
with label_tab:
    with st.expander("🔍 Setting Prompts", expanded=True):
        ...
        try:
            ...
            st.markdown(
    "please follow webapp page instruction first :red[red]!"
)
